...
public class SerializeUtils {
	...
	public static byte[] serializeabePub(abePub pub) {
	...
	public static abePub unserializeabePub(byte[] b) {
		abePub pub;
		int offset;
	...
	/* Method has been test okay */
	public static byte[] serializeabeMsk(abeMsk msk) {
		ArrayList<Byte> arrlist = new ArrayList<Byte>();
	...
	/* Method has been test okay */
	public static abeMsk unserializeabeMsk(abePub pub, byte[] b) {
		int offset = 0;
	...
	/* Method has been test okay */
	public static byte[] serializeabePrv(abePrv prv) {
	...
	/* Method has been test okay */
	public static abePrv unserializeabePrv(abePub pub, byte[] b) {
		abePrv prv;
		int i, offset, len;
	...
	public static byte[] abeCphSerialize(abeCph cph) {
		ArrayList<Byte> arrlist = new ArrayList<Byte>();
	...
	public static abeCph abeCphUnserialize(abePub pub, byte[] cphBuf) {
	...
	private static abePolicy unserializePolicy(abePub pub, byte[] arr,
			int[] offset) {
		int i;
		int n;
